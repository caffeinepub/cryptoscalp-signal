...
export class Backend implements backendInterface {
    ...
    async getAllSignals(): Promise<Array<CoinSignalData>> {
    ...
    async getBacktestResults(arg0: string): Promise<BacktestResult> {
        if (this.processError) {
            try {
                const result = await this.actor.getBacktestResults(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCoinOHLCV(arg0: string): Promise<Array<OHLCV>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCoinOHLCV(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCoinSignal(arg0: string): Promise<Signal> {
        if (this.processError) {
            try {
                const result = await this.actor.getCoinSignal(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTopCoins(): Promise<Array<CryptoCoin>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTopCoins();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
